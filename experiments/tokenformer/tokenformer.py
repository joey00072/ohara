...
MLP_BLOCK = {"MLP": MLP, "GLU": GLU,"Pattention": Pattention}
...
class Attention(nn.Module):
    def __init__(self, config: Config):
        ...
        self.key = Pattention(key_param_tokens=d_model, value_param_tokens=self.head_dim * self.num_kv_heads, param_token_num=d_model, activation_fn=config.activation, dropout_p=config.dropout, bias=config.bias)
        self.query = Pattention(key_param_tokens=d_model, value_param_tokens=self.head_dim * self.num_heads, param_token_num=d_model, activation_fn=config.activation, dropout_p=config.dropout, bias=config.bias)
        self.value = Pattention(key_param_tokens=d_model, value_param_tokens=self.head_dim * self.num_kv_heads, param_token_num=d_model, activation_fn=config.activation, dropout_p=config.dropout, bias=config.bias)
        self.proj = Pattention(key_param_tokens=d_model, value_param_tokens=d_model, param_token_num=d_model, activation_fn=config.activation, dropout_p=config.dropout, bias=config.bias)
...
class Block(nn.Module):
    def __init__(self, config: Config):
        ...
        self.ff = Pattention(
            key_param_tokens=config.d_model,
            value_param_tokens=config.d_model,
            param_token_num=config.hidden_dim,
