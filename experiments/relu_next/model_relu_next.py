...
class ReLU2Function(torch.autograd.Function):
    @staticmethod
    ...
    def backward(ctx, grad_output):
        ...
        grad_input = ((input > 0) * r_input + input) * grad_output
        return grad_input


relu3 = ReLU2Function.apply
ACT2FN["relu3"] = relu3


def silulu(x):
    return F.silu(x) + F.relu(x).square()


ACT2FN["silulu"] = silulu
